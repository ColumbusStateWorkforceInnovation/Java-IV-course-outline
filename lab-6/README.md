...
- [ ] Run your unit tests verifying the tests you added in section 1 now *pass* and the POST, PUT and DELETE tests you added in previous labs all *fail*.
- [ ] Update *only the POST, PUT and DELETE tests from previous* labs (not the ones you added earlier in this lab) as follows:
...
- [ ] After updating the POST, PUT and DELETE tests you added in previous labs, verify all tests now pass.
